...
{  
    if(argc < 5)
    {
        cerr << endl << "Usage: ./mono_mbot path_to_vocabulary path_to_settings path_to_image_folder path_to_times_file (trajectory_file_name)" << endl;
        return 1;
    }
    ...
    tot_images = nImages = vstrImageFilenames.size();
